...
public class Sistema_Academico {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (op) {
                ...
                case 4: menu_Professores(professores, leitura); break;
                case 5: break;
    ...
    public static void menu_Professores(List<Professor> professores, Scanner leitura){
